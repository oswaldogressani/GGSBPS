#------------------------------------------------------------------------------#
#   Simulation study for GGSBPS algorithm (density estimation with n=100)      #
...
write.csv(file = "Simuln100.csv", subperf, row.names = FALSE)
...
png(file = "ScenarioA.png", width = 1000, height = 500)
tarfun
dev.off()

pdf(file = "ScenarioA.pdf", width = 12.3, height = 6)
tarfun
dev.off()
